...
rpm -i cuda-10-0-10.0.130-1.x86_64.rpm

cd /root
wget https://developer.download.nvidia.com/compute/cuda/repos/rhel7/x86_64/cuda-10.0.130-1.x86_64.rpm
rpm -i cuda-10.0.130-1.x86_64.rpm
