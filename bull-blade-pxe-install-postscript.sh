...
cd /root
wget http://172.28.0.254/centos7_x64_everything_1804/libcudnn7-7.4.2.24-1.cuda9.0.x86_64.rpm
...
cd /root
wget http://172.28.0.254/centos7_x64_everything_1804/libcudnn7-devel-7.4.2.24-1.cuda9.0.x86_64.rpm
...
cd /root
wget http://172.28.0.254/centos7_x64_everything_1804/libcudnn7-doc-7.4.2.24-1.cuda9.0.x86_64.rpm
rpm -Uvh libcudnn7-doc-7.4.2.24-1.cuda9.0.x86_64.rpm

mkdir /root/cudnn
cd /root/cudnn
wget http://172.28.0.254/centos7_x64_everything_1804/cudnn-9.0-linux-x64-v7.4.2.24.tgz
